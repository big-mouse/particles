        ...
        painter(self, options){
            ...
            return self => {
                ...
                particles.forEach(particle => {
                    ...
                    const x = self.mouseCoords.x + (crad + particle.distortion * Math.sin(iteration / particle.tmod)) * Math.cos(particle.angle * 180 / Math.PI);
                    const y = self.mouseCoords.y + (crad + particle.distortion * Math.sin(iteration / particle.tmod)) * Math.sin(particle.angle * 180 / Math.PI);
